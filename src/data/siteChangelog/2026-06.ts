...
const jun2026: ChangelogMonth = {
  ...
  entries: [
    ...
    { date: '2026-06-19', type: 'feat', summary: '管理後台描述編輯器新增「數值語法糖一鍵代入」：維護者照抄遊戲原文、用 $1/%1 標記層數／回合數，預覽確認後自動編譯成與 BUFF 連動的數值引用（天賦／技能／BUFF／詞條／模組／武器／元件／背包編輯共用，並含未代入殘留提醒）' },
    ...
    { date: '2026-06-13', type: 'fix', summary: '彩甲升級規劃器切換「核心」路線時，中間的金二節點正確顯示為「核心金二」（核心配色＋兩勳章與正確命名）' },
    { date: '2026-06-12', type: 'refactor', summary: '技能圖示依類型整理至子資料夾（主動／指令／被動／pp／天賦技能），後台圖示選擇器同步支援群組展示；舊扁平路徑自動對應新位置，不影響現有資料' },
    { date: '2026-06-12', type: 'feat', summary: '後台機師天賦編輯器新增「算力改寫（ndVariants）」輸入區：可為每個天賦新增多筆算力階正文（含滿星版），以分區下拉選擇防止手誤；並加入「手動正文保護」勾選框，防止爬蟲補丁覆寫人工填寫的正文' },
